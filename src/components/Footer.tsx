...
const Footer: React.FC = () => {
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      <div className="absolute right-0 top-0 w-96 h-96 bg-gradient-to-br from-purple-600/20 via-blue-600/20 to-transparent rounded-full blur-3xl transform translate-x-32 -translate-y-32"></div>
      <div className="relative z-10 flex flex-col min-h-screen pl-20">
        <div className="flex-1 flex flex-col justify-center md:px-16 lg:px-20 max-w-4xl">
          ...
          <div className="mb-10">
            <h1 className="text-4xl md:text-5xl lg:text-5xl font-light leading-tight mb-4">
              START YOUR JOURNEY
            </h1>
